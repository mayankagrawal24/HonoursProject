...
export default function CommunityScreen(props) {
    ...
    const getNotes = async () => {
        ...
        // return userDoc;
        var dummy = 14;
        const response = await fetch('https://us-central1-honours-project-24ce1.cloudfunctions.net/getPodcastsWithReviews');
        ...
        notesDocs.forEach(async (noteDoc) => {
            ...
            <CommunityNote
                ...
                rando={dummy}
                avgScore={note.reviewScore}
            />);
            dummy = Math.floor(dummy * 0.8);
        });
        setNotes(noteArray);
        setLoaded(true);
    }
    ...
    return (
        <View style={styles.mainContainer}>
            <View style={styles.notesWrapper}>
                <Text style={styles.mainTitle}>Community Notes</Text>
            </View>
